...
if args.test_prompt_file is not None:
    ...
    print("Load pretrained prompts from:", args.test_prompt_file)
...
petri = PetriDish(train_data,population,sample_model,fitness_model,moo_mode,args)

if args.do_dev:
        
    petri.moo_evolute(args.crossover_prob,args.mutate_prob,args.petri_iter_num)
